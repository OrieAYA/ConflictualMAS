...
const std::vector<CityConfig>& CityRegistry::all() {
    ...
    add("Kyoto",      "Kyoto.osm.pbf",      { 135.65, 34.95, 135.85, 35.10 }, CityRole::TrainAndApply,   217.0, 0.04f);
    add("Fukuoka",    "Fukuoka.osm.pbf",    { 130.30, 33.55, 130.55, 33.70 }, CityRole::ComparisonOnly,  340.0, 0.04f);
    add("LosAngeles", "LosAngeles.osm.pbf", {-118.50, 33.90,-118.10, 34.15 }, CityRole::TrainAndApply,  1300.0, 0.05f);
